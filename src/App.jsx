  ...
  <div>
    ...
    <header className="grid grid-cols-3 grid-rows-[10fr_1.5fr_10fr] lg:grid-cols-7 lg:grid-rows-[10fr_1.5fr]">
      ...
      <article className="lg:col-start-5 lg:col-end-8 lg:row-start-1 lg:row-end-2 lg:px-24 flex flex-col justify-center items-start col-start-1 col-end-4 row-start-3 row-end-4 p-8">
        ...
        <p className="text-gray-500 mb-8">We provide unmatched quality, comfort, and style for property owners across the country. 
      ...
      <div className="bg-black text-white flex lg:col-start-5 lg:col-end-6 col-start-3 col-end-4 row-start-2 row-end-3">
          <button className="w-full"><IconPrev className="mx-auto" /></button>
          <button className="w-full"><IconNext className="mx-auto" /></button>
      </div>
    </header>
    <main className="grid grid-cols-1 lg:grid-cols-7">
      ...
      <section className="lg:col-span-3 lg: px-16 flex flex-col justify-center p-8">
        <h2 className="font-bold text-lg uppercase tracking-[0.5rem] mb-6">About our furniture</h2>
